...
from .views import apply_job, application_status,job_applicants,update_application_status,contactus,aboutus,quickeasy, notifications, notifications_json, delete_notification,allcomponies,topcomponies,hiring
...
urlpatterns = [
    ...
    path('allcomponies/', allcomponies, name='allcomponies'),
    path('topcomponies/', topcomponies, name='topcomponies'),
